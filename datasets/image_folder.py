...
class ImageFolder(Dataset):
    ...
    # def img_process(self, file):
    #     if self.mask:
    #         img = Image.open(file).convert('RGB')  # Ensure masks are read in RGB format
    #         print(f"Loaded mask in RGB format: {file}, shape: {img.shape}")
    #         return Image.open(file).convert('RGB')
    #     else:
    #         img = Image.open(file).convert('RGB')  # Ensure images are read in RGB format
    #         print(f"Loaded image in RGB format: {file}, shape: {img.size}")
    #         return Image.open(file).convert('RGB')
