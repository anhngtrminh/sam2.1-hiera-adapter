...
class SegmentationMetric(object):
    ...
    def Class_Wise_Frequency_Weighted_Intersection_over_Union(self):
        ...
        # Calculate the Frequency Weighted IoU (FWIoU) for each class
        class_wise_FWIoU = freq * iu

        # Create a dictionary to store FWIoU for each class
        class_wise_FWIoU_dict = {}
        for class_idx in range(len(class_wise_FWIoU)):
            class_wise_FWIoU_dict[f'Class_{class_idx}'] = class_wise_FWIoU[class_idx]

        return class_wise_FWIoU_dict
