...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        # print("src shape after adding dense_prompt_embeddings", src.shape)
        assert (
            image_pe.size(0) == 1
        ...
        if not self.use_high_res_features:
            ...
            upscaled_embedding_feat = act1(ln1(dc1(src_feature) + feat_s1))
            upscaled_embedding_feat = act2(dc2(upscaled_embedding_feat) + feat_s0)
        ...
        upscaled_embedding_concat = torch.cat([upscaled_embedding, upscaled_embedding_feat],dim=1)
